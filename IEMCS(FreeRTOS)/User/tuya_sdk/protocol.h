...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "pd64zqd2nmtcf7zu"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//烟雾浓度(只上报)
//备注:
#define DPID_SMOKE_CONCENTRATION 101
//灯(可下发可上报)
//备注:
#define DPID_LIGHT 104
//风扇(可下发可上报)
//备注:
#define DPID_FAN 106
//加热器(可下发可上报)
//备注:
#define DPID_HEATER 107
//亮度值(只上报)
//备注:
#define DPID_L 108
//烟雾报警(只上报)
//备注:
#define DPID_SMLAL 109
//灯光自动(可下发可上报)
//备注:
#define DPID_LIGHT_A 110
//温度自动(可下发可上报)
//备注:
#define DPID_TEMP_A 111
//湿度自动(可下发可上报)
//备注:
#define DPID_HUMI_A 112
//温度设置(可下发可上报)
//备注:
#define DPID_TEMP_S 113
//湿度设置(可下发可上报)
//备注:
#define DPID_HUMI_S 114
